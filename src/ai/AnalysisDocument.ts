...
export const ANALYSIS_DOCUMENT_JSON_SCHEMA = {
  ...
  properties: {
    meetingId: { type: "string", minLength: 1, maxLength: 64 },
    ...
    decisions: {
      ...
      items: {
        ...
        properties: {
          decisionId: { type: "string", minLength: 1, maxLength: 16 },
          text: { type: "string", minLength: 1, maxLength: 160 },
          owner: { type: "string", maxLength: 48 },
          decidedAt: { type: "string", maxLength: 40 },
        },
      },
    },
    tasks: {
      ...
      items: {
        ...
        properties: {
          taskId: { type: "string", minLength: 1, maxLength: 16 },
          text: { type: "string", minLength: 1, maxLength: 140 },
          assignee: { type: "string", maxLength: 48 },
          dueDate: { type: "string", maxLength: 40 },
          status: { type: "string", enum: ["OPEN", "IN_PROGRESS", "DONE", "CANCELLED"] },
        },
      },
    },
    risks: { type: "array", maxItems: 6, items: { type: "string", maxLength: 120 } },
    questions: { type: "array", maxItems: 6, items: { type: "string", maxLength: 120 } },
    followups: { type: "array", maxItems: 6, items: { type: "string", maxLength: 120 } },
  },
} as const;

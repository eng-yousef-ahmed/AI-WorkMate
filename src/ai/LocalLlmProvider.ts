...
export function buildAnalysisPrompt(transcript: TranscriptDocument, createdAt: string): string {
  ...
  return [
    ...
    "Summary quality contract: the one-sentence summary must contain at least one exact core decision phrase copied from the transcript, such as \"local only\", \"meeting files\", or \"Windows verification\"; do not invent the phrase, copy the wording actually spoken.",

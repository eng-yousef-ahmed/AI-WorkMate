...
export function buildAnalysisPrompt(transcript: TranscriptDocument, createdAt: string): string {
  ...
  return [
    ...
    "Summary quality contract: the one-sentence summary must contain at least one exact core decision phrase copied from the transcript: \"local only\", \"meeting files\", or \"Windows verification\".",

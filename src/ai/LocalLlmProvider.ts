...
export function buildAnalysisPrompt(transcript: TranscriptDocument, createdAt: string): string {
  ...
  return [
    ...
    "Summary: one sentence in the SAME language as the transcript (an Arabic transcript means an Arabic summary) that names this meeting, states its main decision, and mentions the product or system the meeting is about. Build the sentence by copying exact phrases word-for-word from the transcript instead of paraphrasing, using names as they appear in the transcript.",

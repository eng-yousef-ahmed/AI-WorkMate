import { runWindowsRuntimeWindowCaptureVerification } from "../src/capture/WindowsRuntimeWindowCaptureVerification";
...
async function main(): Promise<void> {
  ...
  const result = await runWindowsRuntimeWindowCaptureVerification({
